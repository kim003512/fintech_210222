    ...
    <div class="wrapper">
        ...
        <nav class="menu">
          ...
          <div class="nav-container">
            <ul class="main-menu">
              <li class="active">
                <a href="index.html"
                  ><img src="img/content/icons/1.png" alt="" /><strong
                    class="special"
                    >Dashboard</strong
                  >
                </a>
              ...
              <li class="">
                <a href="wallet.html"
                  ><img src="img/content/icons/2.png" alt="" /><strong
                    class="special"
                    >My Walet</strong
                  >
                </a>
              ...
              <li class="">
                <a href="trading.html"
                  ><img src="img/content/icons/3.png" alt="" /><strong
                    class="special"
                    >Crypto Trade</strong
                  >
                </a>
              ...
              <li class="">
                <a href="buy-sell.html"
                  ><img src="img/content/icons/6.png" alt="" /><strong
                    class="special"
                    >Buy & sell</strong
                  >
                </a>
              ...
              <li class="">
                <a href="profile.html"
                  ><img src="img/content/icons/5.png" alt="" /><strong
                    class="special"
                    >Trader Profile</strong
                  >
                </a>
              </li>
              <li class="">
                <a href="affiliate.html"
                  ><img src="img/content/icons/4.png" alt="" /><strong
                    class="special"
                    >Affiliate System</strong
                  >
                </a>
              </li>
              <li class="">
                <a href="setting.html"
                  ><img src="img/content/icons/11.png" alt="" /><strong
                    class="special"
                    >Settings</strong
                  >
                </a>
              ...
              <li>
                <a href="javascript:void(0);"
                  ><img src="img/content/icons/9.png" alt="" /><strong
                    class="special"
                ...
                <ul>
                  ...
                  <li>
                    <a href="forgot-password.html" data-loader="show"
                      >Forgot Password</a
                    >
                  </li>
                </ul>
              ...
              <li>
                <a href="javascript:void(0);"
                  ><img src="img/content/icons/8.png" alt="" />
                  <strong class="special">Wizards</strong>
                  <span class="fa fa-angle-down"></span
                ></a>
                <ul>
                  <li>
                    <a href="wizard-default.html" data-loader="show"
                      >Wizard Default</a
                    >
                  </li>
                  <li>
                    <a href="wizard-fullscreen.html" data-loader="show"
                      >Wizard Fullscreen</a
                    >
                  </li>
                </ul>
              ...
              <li class="">
                <a href="charts.html"
                  ><img src="img/content/icons/14.png" alt="" /><strong
                    class="special"
                    >Charts</strong
                  >
                </a>
              ...
              <li>
                <a href="forms.html" data-loader="show"
                  ><img src="img/content/icons/7.png" alt="" /><strong
                    class="special"
                    >Form Elements</strong
                  ></a
                >
              </li>
              <li>
                <a href="#"
                  ><img src="img/content/icons/10.png" alt="" /><strong
                    class="special"
                  >
                    Components</strong
                  >
                ...
                <ul>
                  <li>
                    <a href="tab-bottom.html" data-loader="show"
                      >Tab (Bottom)</a
                    >
                  </li>
                  <li>
                    <a href="tab-top.html" data-loader="show">Tab (Top)</a>
                  </li>
                  <li>
                    <a href="accordion.html" data-loader="show">Accordion</a>
                  </li>
                  <li>
                    <a href="popup.html" data-loader="show">Popup Modal</a>
                  </li>
                  <li>
                    <a href="checkbox-list.html" data-loader="show"
                      >Check List</a
                    >
                  </li>
                  <li>
                    <a href="link-list.html" data-loader="show">Link List</a>
                  </li>
                  <li>
                    <a href="link-list-two-column.html" data-loader="show"
                      >Two Column Links</a
                    >
                  </li>
                </ul>
              ...
              <li class="">
                <a href="#"
                  ><img src="img/content/icons/15.png" alt="" /><strong
                    class="special"
                  >
                    Pages</strong
                  >
                ...
                <ul>
                  <li class="">
                    <a href="profile.html" data-loader="show">User Profile</a>
                  </li>
                  <li>
                    <a href="search-result.html" data-loader="show"
                      >Search Results</a
                    >
                  </li>
                  <li><a href="contact.html" data-loader="show">Contact</a></li>
                  <li>
                    <a href="blank.html" data-loader="show">Blank Page</a>
                  </li>
                </ul>
              </li>
            </ul>
      ...
      <div class="wrapper-inline">
        ...
        <div class="search-form">
          <span class="close-search-form" data-search="close"
